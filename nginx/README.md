...
![Version: 15.12.2](https://img.shields.io/badge/Version-15.12.2-informational?style=flat-square) ![AppVersion: 1.25.4](https://img.shields.io/badge/AppVersion-1.25.4-informational?style=flat-square)
...
| cloneStaticSiteFromGit.gitSync.resourcesPreset | string | `"none"` |  |
...
| cloneStaticSiteFromGit.image.tag | string | `"2.43.2-debian-12-r2"` |  |
...
| image.tag | string | `"1.25.4-debian-12-r2"` |  |
...
| metrics.image.tag | string | `"1.1.0-debian-12-r7"` |  |
...
| metrics.resourcesPreset | string | `"none"` |  |
